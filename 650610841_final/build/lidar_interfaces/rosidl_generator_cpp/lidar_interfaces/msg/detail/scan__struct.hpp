...
#ifndef LIDAR_INTERFACES__MSG__DETAIL__SCAN__STRUCT_HPP_
#define LIDAR_INTERFACES__MSG__DETAIL__SCAN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lidar_interfaces__msg__Scan __attribute__((deprecated))
#else
# define DEPRECATED__lidar_interfaces__msg__Scan __declspec(deprecated)
#endif
...
struct Scan_
{
  ...
  // pointer types
  using RawPtr =
    lidar_interfaces::msg::Scan_<ContainerAllocator> *;
  using ConstRawPtr =
    const lidar_interfaces::msg::Scan_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lidar_interfaces::msg::Scan_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lidar_interfaces__msg__Scan
    std::shared_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lidar_interfaces__msg__Scan
    std::shared_ptr<lidar_interfaces::msg::Scan_<ContainerAllocator> const>
...
using Scan =
  lidar_interfaces::msg::Scan_<std::allocator<void>>;
...
#endif  // LIDAR_INTERFACES__MSG__DETAIL__SCAN__STRUCT_HPP_
