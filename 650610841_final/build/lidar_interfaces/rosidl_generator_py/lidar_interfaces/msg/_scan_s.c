...
bool lidar_interfaces__msg__scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lidar_interfaces.msg._scan.Scan", full_classname_dest, 31) == 0);
  }
  lidar_interfaces__msg__Scan * ros_message = _ros_message;
  {  // header
...
PyObject * lidar_interfaces__msg__scan__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lidar_interfaces.msg._scan");
